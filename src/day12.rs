...
pub fn day12_part2(input: &Vec<NavInstruction>) -> i32 {
    let endpoint = input
        .iter()
        .scan(ShipStatusWP{ e:0, n: 0, wp_e: 10, wp_n: 1, d: 0}, |status, &i| {
...
pub fn move_ship(s: ShipStatus, i: &NavInstruction) -> ShipStatus {
    match i.action {
        ...
        'L' => ShipStatus{ e: s.e, n: s.n, d: (s.d - i.val + 360) % 360 },
        'R' => ShipStatus{ e: s.e, n: s.n, d: (s.d + i.val + 360) % 360 },
...
pub fn move_ship_wp(s: ShipStatusWP, i: &NavInstruction) -> ShipStatusWP {
    match i.action {
        ...
        _ => ShipStatusWP{e: 0, n:0, wp_e: 0, wp_n: 0, d: 0}
    }
}
...
pub fn move_wp_by_direction(s: ShipStatusWP, d: i32, val: i32) -> ShipStatusWP {
    match d {
        // EAST
        0 => ShipStatusWP{ e: s.e, n: s.n, wp_e: s.wp_e + val, wp_n: s.wp_n, d: s.d},
        // SOUTH
        90 => ShipStatusWP{ e: s.e, n: s.n, wp_e: s.wp_e, wp_n: s.wp_n - val, d: s.d},
        // EAST
        180 => ShipStatusWP{ e: s.e, n: s.n, wp_e: s.wp_e - val, wp_n: s.wp_n, d: s.d},
        // NORTH
        270 => ShipStatusWP{ e: s.e, n: s.n, wp_e: s.wp_e, wp_n: s.wp_n + val, d: s.d},
        _ => ShipStatusWP{e: 0, n:0, wp_e: 0, wp_n: 0, d: 0}
    }
}
...
pub fn move_by_direction(s: ShipStatus, d: i32, val: i32) -> ShipStatus {
    match d {
        // EAST
        0 => ShipStatus{ e: s.e + val, n: s.n, d: s.d},
        // SOUTH
        90 => ShipStatus{ e: s.e, n: s.n - val, d: s.d},
        // WEST
        180 => ShipStatus{ e: s.e - val, n: s.n, d: s.d},
        // NORTH
        270 => ShipStatus{ e: s.e, n: s.n + val, d: s.d},
        _ => ShipStatus{ e:0, n:0, d: 0}
    }
}
...
F11";
        let gen = day12_generator(sample);
        let state = ShipStatusWP{ e:0, n: 0, wp_e: 10, wp_n: 1, d: 0};
